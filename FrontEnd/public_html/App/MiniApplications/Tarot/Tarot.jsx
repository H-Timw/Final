  ...
  useEffect(() =>{
    ...
    if(light != null && shadow != null){
      getMeanings([{
        title: 'Light',
        key: 'light',
        icon: <Image preview={false} style={{paddingRight:10}} width={32} src={lightIcon}></Image>,
        children: getChildrenItems(light,`light`),
      },
      {
        title: 'Shadow',
        key: 'shadow',
        icon: <Image preview={false} style={{paddingRight:10}} width={32} src={shadowIcon}></Image>,
      ...
      </Button>
      {
        ...
        && <Space
              ...
              >
                ...
                <Title level={4}>{`Fortune Telling: ${cards.fortune_telling}`}</Title>
                <Button
