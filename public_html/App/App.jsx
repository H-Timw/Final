...
export default function App() {
  ...
  const styleIconSubMenu = collapsed
    ? { width: 20, height: 20, marginRight: 30 }
    ...
    getItem(
      <Typography>
        <Space>
          ...
          {!collapsed && (
            <Text type="secondary" style={{ fontSize: 16, color: "#818CF8" }}>
              {language == "us" ? `LEARNING` : `Học Tập`}
            </Text>
          )}
        </Space>
        {!collapsed && (
          ...
          >
            <nobr>
              {language == "us" ? `Your Workspace` : `Tập trung với công việc`}
            </nobr>
          </Text>
        )}
      </Typography>,
    ...
    getItem(
      <Typography>
        <Space>
          ...
          {!collapsed && (
            <Text style={{ fontSize: 16, color: "#818CF8" }}>
              {language == "us" ? `APPLICATIONS` : `Giải Trí`}
            </Text>
          )}
        </Space>
        {!collapsed && (
          ...
          >
            <nobr>
              {language == "us"
                ...
                : `Khu vực thư giãn của riêng bạn`}
            </nobr>
          </Text>
        )}
      </Typography>,
    ...
    getItem(
      ...
      [
        ...
        getItem(
          ...
          "/tarot",
          <Image preview={false} style={styleIconSubMenu} src={tarot} />
        ),
      ],
      "group"
    ),
    getItem(
      <Typography>
        <Space>
          ...
          {!collapsed && (
            <Text type="secondary" style={{ fontSize: 16, color: "#818CF8" }}>
              {language == "us" ? `PLANNING` : `Kế hoạch làm việc`}
            </Text>
          )}
        </Space>
        {!collapsed && (
      ...
      [
        ...
        getItem(
          ...
          "/worldtime",
          <Image preview={false} style={styleIconSubMenu} src={earthTime} />
        ),
      ],
      "group"
    ),
    ...
    api.open({
      ...
      message: (
        <p style={{ paddingLeft: 40 }}>
          {language == "us"
            ? `You "ve finish a section successfully!`
            : `Xuất sắc!!! Bạn vừa hoàn thành một chu kỳ!`}
        </p>
      ),
      description: (
        <p style={{ paddingLeft: 40 }}>
      ...
      message: (
        <p style={{ paddingLeft: 40 }}>
          {language == "us"
            ...
            : `Một khoảng nghỉ ngơi tuyệt vời chứ?`}
        </p>
      ),
      description: (
        <p style={{ paddingLeft: 40 }}>
          {language == "us"
            ? `Remember to comeback with your target!!!`
            : `Hãy nhớ tới mục tiêu của mình nào!!!`}
        </p>
      ),
      btn,
      key,
  ...
  return (
    <>
      {token ? (
        ...
        >
          <Layout theme={theme} hasSider={true}>
            {profile && (
              <Sider
                theme={theme}
                style={siderStyle}
            ...
            >
              ...
              >
                ...
                <Space>
                  <Image
                    ...
                    src={theme == "dark" ? logoKITSBGBlue : logoKITSBGWhite}
                  />
                  <Title
                    level={3}
                    style={{
                  ...
                  >
                    {language == "us"
                      ? `KITS Final FrontEnd`
                      : `Đồ án tốt nghiệp FrontEnd KITS`}
                  </Title>
                </Space>
                <Space>
                  <Setting
              ...
              >
                {language == "us"
                  ? `Copyright by TIMW ${String.fromCodePoint(0x00a9)} 2023`
                  : `Thực hiện bởi Đoàn Minh Hào - KITS-4 - 2023`}
              </Footer>
            </Layout>
          </Layout>
          <Outlet />
