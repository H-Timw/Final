  ...
  return (
    <>
      <Image
        preview={false}
        width={"24px"}
        src={theme == "light" ? blackIconMenu : whiteIconMenu}
        onClick={showSetting}
      ></Image>
      <Drawer
        style={{ backgroundColor: theme == "dark" ? "#0B3B61" : "white" }}
        title={
          <Text style={{ fontSize: 22, color: colorTextByTheme }}>Setting</Text>
        }
        placement="right"
        onClose={onClose}
        open={openSetting}
      ...
      >
        <Space>
          <Image
            preview={false}
            style={{ height: "24px", width: "auto", stroke: colorTextByTheme }}
            src={iconLanguage}
          />
          <Text
            style={{
          ...
          >
            <Option value="us">
              <Image preview={false} width={"24px"} src={enUs} />
            </Option>
            <Option value="vi">
              <Image preview={false} width={"24px"} src={vi} />
            </Option>
          </Select>
        </Space>
        <Space>
          <Typography style={{ marginTop: 20 }}>
            <Text style={{ color: colorTextByTheme, marginRight: 20 }}>
            ...
            <Switch
              ...
              checkedChildren={
                <Text style={{ color: "white", lineHeight: "20px" }}>
                  {language == "us" ? "Dark" : "Tối"}
                </Text>
              }
              unCheckedChildren={
                <Text style={{ color: "black", lineHeight: "19px" }}>
                  {language == "us" ? "Light" : "Sáng"}
                </Text>
              }
